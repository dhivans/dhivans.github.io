...
| 7 | Rest of the product page standard (§2): cross-sell links | "Commonly used with" turns single-item sales into multi-item ones — free once written | ⬜ (checked 2026-09-03: no automation exists for this anywhere in the pipeline, and 0 of 46 products have `related:` set — same unused-but-built state as #4 was) |
